...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, Object>> handleResourceNotFoundException(
    ...
    return buildResponse(
        HttpStatus.NOT_FOUND.value(), ex.getClass().getSimpleName(), ex.getMessage());
  }

  @ExceptionHandler(ConflictException.class)
  public ResponseEntity<Map<String, Object>> handleConflictException(ConflictException ex) {
    return buildResponse(
        HttpStatus.CONFLICT.value(), ex.getClass().getSimpleName(), ex.getMessage());
  }
  ...
  public ResponseEntity<Map<String, Object>> handleAuthenticationException(Exception ex) {
    return buildResponse(
        HttpStatus.UNAUTHORIZED.value(), ex.getClass().getSimpleName(), ex.getMessage());
  }
